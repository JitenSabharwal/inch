...
$result1=mysqli_query($con,"SELECT * from orders,stg_status  where st_status='PM' group by or_prjname ");       
//######################################################
     ...
     function display_project()//function to display the table values 
          {
            ?>          
        <tr>
              <td><a href="pm_page.php?op=<?php echo $_REQUEST['op']; ?>&search=click&pn=<?php echo $_SESSION['project_name']; ?>&or=<?php echo $_SESSION['order'];?>&po=click"> <?php  echo @$_SESSION['project_name'];  ?></a></td>
