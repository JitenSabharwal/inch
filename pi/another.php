     ...
     function display_project()//function to display the table values 
          {
            ?>          
        <tr>
              <td><a href="pi_page.php?op=<?php echo $_REQUEST['op']; ?>&search=click&pn=<?php echo $_SESSION['project_name']; ?>&or=<?php echo $_SESSION['order'];?>&po=click&quote=0"> <?php  echo @$_SESSION['project_name'];  ?></a></td>
