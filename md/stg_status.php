...
?>
			<tr>
					<td><a href="md_page.php?op=<?php echo $_REQUEST['op']; ?>&search=click&pn=<?php echo $_REQUEST['pn']; ?>&or=<?php echo $_REQUEST['or'];?>&po=click&status=stage&st=<?php echo $_SESSION['stg_id'];?>&st_click=click"><?php echo $_SESSION['stg_id'];?></a></td>
